...
//import com.stone.xiaodian.TMainActivity;
...
public class FileExplorerTabActivity extends FragmentActivity {
    ...
    FileExplorerTabActivity containerActivity;
	public TabsAdapter(FileExplorerTabActivity paramTMainActivity, FragmentManager paramFragmentManager,ViewPager viewPager)
	  {
		super(paramFragmentManager);
		 mContext = paramTMainActivity;
		 mActionBar = paramTMainActivity.getActionBar();
...
//        }
        ...
        public android.support.v4.app.Fragment getItem(int position) {
            ...
            if (info.fragment == null) {
                info.fragment = android.support.v4.app.Fragment.instantiate(mContext, info.clss.getName(), info.args);
            }
