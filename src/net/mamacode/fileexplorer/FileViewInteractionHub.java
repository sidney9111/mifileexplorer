...
package net.mamacode.fileexplorer;

import net.mamacode.fileexplorer.FileListItem.ModeCallback;
import net.mamacode.fileexplorer.FileOperationHelper.IOperationProgressListener;
import net.mamacode.fileexplorer.FileSortHelper.SortMethod;
import net.mamacode.fileexplorer.FileViewActivity.SelectFilesCallback;
import net.mamacode.fileexplorer.TextInputDialog.OnFinishListener;
...
public class FileViewInteractionHub implements IOperationProgressListener {
    ...
    private net.mamacode.fileexplorer.FileViewInteractionHub.Mode mCurrentMode;
